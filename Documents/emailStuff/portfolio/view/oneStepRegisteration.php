...
<html lang="en">
    ...
    <head>
        <title>One Step Registration</title>
        <meta charset="utf-8">
    ...
    <body class="body">
        ...
        <div class="container">
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th><h3><b>Personal Information</b></h3></th>
                        <th></th>
                        <th></th>
                    </tr>
                </thead>
        ...
        <div class="container">
            <table class="table">
                <thead>
                    <tr>
                        <th><h3><b>Education Information</b></h3></th>
                        <th></th>
                        <th></th>
                    </tr>
                </thead>
                ...
                <form id="userEducationform" name="educationform" onsubmit="return test()"  method="POST" action="adapters/ControllerEducationAdapter.php" >
                    ...
                    <tr class="success">
                        ...
                        <td>
                            <div id="submit_div" class="form-group">
                                <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <button id="submit" name="addNewSkill" type="submit" value="Submit" form="userEducationform" class="btn btn-lg btn-info ">Add More Skills</button>
        ...
        <div class="container">
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th><h3><b>Skills Information</b></h3></th>
                        <th></th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                <form id="userSkillsform" name="skillsform" onsubmit="return test()"  method="POST" action="adapters/ControllerSkillsAdapter.php" >
                    <input name="personId" id="personId" class="form-control" type="hidden"  value=<?php echo $_SESSION["personId"]; ?> >
                    <tr class="success">
                        <td>
        ...
        <!-- iFrame -->
        <div class="container">
            <iframe src="signup.php" height="600" width="1200" title="Iframe Example"></iframe>
        </div>
